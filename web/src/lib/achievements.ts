...
const SECRET_ACHIEVEMENTS: AchievementDef[] = [
   ...
   },
   {
      ...
      icon: faClover,
      tiers: null,
      singleName: "Lucky Clover",
      singleDescription: "Play a game on St. Patrick's Day",
   },
   {
      id: "easter_egg",
      secret: true,
      icon: faEgg,
      tiers: null,
      singleName: "Easter Egg",
      singleDescription: "Play a game on Easter",
   },
   {
      id: "fireworks",
      secret: true,
      icon: faSparkles,
      tiers: null,
      singleName: "Fireworks",
      singleDescription: "Play a game on the 4th of July",
   },
   {
      id: "spooky",
      secret: true,
      ...
      tiers: null,
      singleName: "Spooky",
      singleDescription: "Play a game on Halloween",
   },
   {
      id: "thankful",
      secret: true,
      ...
      tiers: null,
      singleName: "Thankful",
      singleDescription: "Play a game on Thanksgiving",
   },
   {
      id: "christmas_spirit",
      secret: true,
...
export function computeAchievements(
   ...
   const secretChecks: {
      ...
      { def: secretById.spooky, unlocked: stats.spooky },
      { def: secretById.thankful, unlocked: stats.thankful },
      {
