...
describe("ActiveGameModal", () => {
   it("shows initial state with game in progress message", () => {
      render(<ActiveGameModal onContinue={vi.fn()} onConcede={vi.fn()} />);
      expect(screen.getByText("Game In Progress")).toBeInTheDocument();
      expect(screen.getByText(/You have a game active/)).toBeInTheDocument();
   });
   ...
   it("clicking Continue calls onContinue", async () => {
      ...
      render(<ActiveGameModal onContinue={onContinue} onConcede={vi.fn()} />);
   ...
   it("confirmation Yes calls onConcede", async () => {
      ...
      render(<ActiveGameModal onContinue={vi.fn()} onConcede={onConcede} />);
      await user.click(screen.getByRole("button", { name: "Concede" }));
