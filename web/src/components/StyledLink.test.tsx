...
describe("StyledLink", () => {
   ...
   it("renders http links as <a> tags", () => {
      renderInRouter(<StyledLink href="http://example.com">HTTP</StyledLink>);
      const link = screen.getByText("HTTP");
      expect(link.tagName).toBe("A");
   });

   it("renders internal links as React Router Links", () => {
      renderInRouter(<StyledLink href="/user">Internal</StyledLink>);
   ...
   it("applies link class", () => {
      renderInRouter(<StyledLink href="/test">Link</StyledLink>);
      expect(screen.getByText("Link")).toHaveClass("link");
   });

   it("applies additional className", () => {
      renderInRouter(
         <StyledLink href="/test" className="extra">
            Link
         </StyledLink>
      );
