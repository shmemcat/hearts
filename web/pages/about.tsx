               ...
               <main className={containers["about-body-container"]}>
                  <div className={containers["about-text-body"]}>
                     <span style={{ margin: "0px" }}>
                        ...
                        . I&apos;m a software engineer developing this web
                        application in React and Python. Eventually, you&apos;ll
                        be able to play Hearts games locally with AI and online
                        with friends. This has been a fun project to work on;
                        it&apos;s been a decade and a half since I&apos;ve been
                        immersed in web development (as you can imagine, a
                        lot&apos;s changed since then) so learning an array of
                        new technologies has been an exceptionally fun
                     ...
                     <span style={{ display: "block", marginTop: "1em" }}>
                        ...
                        me with its whimsical yet balanced design. I&apos;m
                        looking forward to making this app a proper tribute to
                        this fantastic deck.
                     </span>
                     <span style={{ display: "block", marginTop: "1em" }}>
                        For as long as I can remember, my mom played Hearts on
                        Yahoo Games when I was growing up. She&apos;s excellent
                        at it, and playing with her and her brothers is nothing
                        short of punishing. My mom mentioned on more than one
                        occasion how the Hearts apps she&apos;s always used have
                        the tendency to be{" "}
                        <span style={{ fontSize: "12px" }}>*ahem*</span> homely,
                        so I&apos;d love to create for her an aesthetically
                        pleasing experience of her favorite card game.
                     </span>
                     <span style={{ display: "block", paddingTop: "1em" }}>
                        <br />
                        <Link href="/">
                           <Button name="Home" />
                        </Link>
                  ...
                  <div className={containers["about-image-wrapper"]}>
                     <Image
